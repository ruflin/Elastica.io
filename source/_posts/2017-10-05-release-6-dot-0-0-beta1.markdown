...
This release is compatible with Elasticsearch 6.x and was tested with [elasticsearch 6.0.0-rc1](https://www.elastic.co/guide/en/elasticsearch/reference/6.0/release-notes-6.0.0-rc1.html).
